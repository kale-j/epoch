          ...
          DO j = 1-ng,ny+ng
             DO i = 1-ng,nx+ng
                ey_total(i,j) = ey_total(i,j) + e0_amp * &
                     EXP( -iw02*((y(j)-yf)*(y(j)-yf)+zf*zf)/(1+irayl2*(xf-xb(i))**2) &
          ...
          DO j = 1-ng,ny+ng
             DO i = 1-ng,nx+ng
                bz_total(i,j) = bz_total(i,j) + b0_amp * &
                     EXP( -iw02*((y(j)-yf)*(y(j)-yf)+zf*zf)/(1+irayl2*(xf-x(i))**2) &
