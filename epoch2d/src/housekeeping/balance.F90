...
CONTAINS
  ...
  SUBROUTINE redistribute_fields(new_domain)
    ...
    ALLOCATE(ez_total(1-ng:nx_new+ng, 1-ng:ny_new+ng))
    ALLOCATE(bx_total(1-ng:nx_new+ng, 1-ng:ny_new+ng))
    ALLOCATE(by_total(1-ng:nx_new+ng, 1-ng:ny_new+ng))
    ALLOCATE(bz_total(1-ng:nx_new+ng, 1-ng:ny_new+ng))
#endif    
